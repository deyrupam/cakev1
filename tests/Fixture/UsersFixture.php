...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-19 10:00:33',
                'modified' => '2019-03-19 10:00:33'
            ],
        ];
        parent::init();
    }
